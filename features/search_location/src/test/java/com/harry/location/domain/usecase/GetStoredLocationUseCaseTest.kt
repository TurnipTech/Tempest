...
class GetStoredLocationUseCaseTest {
    ...
    @Test
    fun `should return stored location when repository has location`() = runTest {
    ...
    @Test
    fun `should return null when repository has no stored location`() = runTest {
    ...
    @Test
    fun `should return location with minimal data when repository returns minimal location`() = runTest {
